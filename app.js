...
(function () {
  ...
  function renderActionCloud(root) {
    ...
    // ── Layout ─────────────────────────────────────────────────────────
    // Canvas dimensions are determined at render time by the surrounding
    // container; SVG uses an internal coordinate system that adapts.
    const SVG = $('#cloudSvg');
    const wrap = SVG.parentElement;
    const W = Math.max(720, wrap.clientWidth || 1200);
